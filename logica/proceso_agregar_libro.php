...
if (isset($_POST) && !empty($_POST)) {
    ...
    $res = $libros->insertarLibro($id, $titulo, $autor, $genero, $anio_publicacion, $descripcion);

    if ($res) {
        header("Location: ../mostrarLibros.php?msg=1");
    } else {
        header("Location: ../mostrarLibros.php?msg=4");
    }
}
?>
